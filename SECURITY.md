...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `tracefixture` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in tracefixture.
